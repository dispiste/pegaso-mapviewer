...
function initMapPanel() {
	...
	*/
	...
	map.addLayers([
			...
			new OpenLayers.Layer.WMS("DEM I",
				"http://pegasosdi.uab.es/ogc/wms?", {
					layers: "EDM_USGS_W020N40",
					transparent: true,
					format: "image/png"
				}, {
					isBaseLayer: false,
			...
			new OpenLayers.Layer.WMS("DEM II",
				"http://pegasosdi.uab.es/ogc/wms?", {
					layers: "EDM_USGS_E020N40",
					transparent: true,
					format: "image/png"
				}, {
					isBaseLayer: false,
			...
			new OpenLayers.Layer.WMS("DEM III",
				"http://pegasosdi.uab.es/ogc/wms?", {
					layers: "EDM_USGS_W020N90",
					transparent: true,
					format: "image/png"
				}, {
					isBaseLayer: false,
			...
			new OpenLayers.Layer.WMS("DEM IV",
				"http://pegasosdi.uab.es/ogc/wms?", {
					layers: "EDM_USGS_E020N90",
					transparent: true,
					format: "image/png"
				}, {
					isBaseLayer: false,
			...
			new OpenLayers.Layer.WMS("Mediterranean and Black Seas",
				"http://pegasosdi.uab.es/ogc/wms?", {
